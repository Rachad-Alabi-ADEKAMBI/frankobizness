 <nav>
     ...
     <ul>
         <li><a class="" href="./index.php?action=home"><i class="fas fa-home"></i> Accueil</a></li>
         <li>
         ...
         <li><a class="login-link <?php echo $current_page == 'login.php'
                ? 'active'
                : null; ?>" href="./index.php?action=login"><i class="fas fa-sign-in-alt"></i> Connexion</a></li>

         <?php else: ?>

         <li><a class="<?php echo $current_page == 'dashboard.php'
                ? 'active'
                : null; ?>" href="./index.php?action=dashboard"> <i class="fas fa-columns"></i> Tableau de bord</a>
         </li>
